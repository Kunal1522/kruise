...
func (h *ContainerRecreateRequestHandler) handleV1alpha1(ctx context.Context, req admission.Request) admission.Response {
	...
	if err := injectPodIntoContainerRecreateRequestV1alpha1(obj, pod); err != nil {
		return admission.Errored(http.StatusBadRequest, err)
	}
...
func injectPodIntoContainerRecreateRequestV1alpha1(obj *appsv1alpha1.ContainerRecreateRequest, pod *v1.Pod) error {
